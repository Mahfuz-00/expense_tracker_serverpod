...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i6.BudgetNotification) {
      return _i6.BudgetNotification.fromJson(data) as T;
    }
    if (t == _i7.Expense) {
    ...
    if (t == _i1.getType<_i6.BudgetNotification?>()) {
      return (data != null ? _i6.BudgetNotification.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'BudgetNotification') {
      return deserialize<_i6.BudgetNotification>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'expense_app_admin';
